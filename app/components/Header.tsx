  ...
  return (
    <div className='w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col justify-center items-center gap-4 '> 
        ...
        <h3 className='flex items-end gap-2 text-xl md:text-2xl mb-3 font-ovo'>
            Hi! I’m Krunal Rathod 
            <Image src={assets.hand_icon} alt='' className='w-6'/>
        </h3>
        <h1 className='text-3xl sm:text-6xl lg:text-[60px] font-ovo'>Frontend Developer Creating Fast & Responsive Websites.</h1>

        <p className='max-w-2xl mx-auto font-ovo'>Frontend Developer from Ahmedabad, India. I build responsive, modern and user-friendly web applications using React, Next.js and Tailwind CSS.</p>
